        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
          <div className="flex space-x-0 overflow-x-auto">
            {[
              ...
              { key: 'upcoming', label: 'Upcoming', count: bookings.filter(b => new Date(b.start_time) > new Date() && b.status !== 'cancelled').length },
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <div className="flex space-x-3">
                        ...
                        {(booking.status === 'confirmed' || booking.status === 'accepted') && new Date(booking.start_time) > new Date() && (
                          <button
          ...
          <div className="relative top-10 mx-auto p-5 border w-full max-w-2xl bg-white rounded-lg shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end space-x-4">
                ...
                {(selectedBooking.status === 'confirmed' || selectedBooking.status === 'accepted') && new Date(selectedBooking.start_time) > new Date() && (
                  <button
                    onClick={() => {
