...
export default function PartnerDashboard() {
  ...
  const handleQuickEditVehicle = (vehicle) => {
    ...
    // Open quick edit modal or navigate to edit page
    console.log('Quick edit vehicle:', vehicle)
  }

  const handleManageVehicle = (vehicle) => {
    setSelectedVehicle(vehicle)
    // Open manage modal or navigate to manage page
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {showAddVehicleModal && (
        <AddVehicleModal 
          ...
          onPhotoChange={handleVehiclePhotoChange}
          onRemovePhoto={handleRemoveVehiclePhoto}
