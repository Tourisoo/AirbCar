...
help:
	...
	@echo ""
	@echo "$(BOLD)$(RED)⚠️  Note:$(RESET) Use $(YELLOW)make local$(RESET) for local development with PostgreSQL"
	@echo ""

run:
	@echo "$(BOLD)$(RED)╔══════════════════════════════════════════════════════════════════════════════╗$(RESET)"
	@echo "$(BOLD)$(RED)║$(RESET) $(BOLD)$(WHITE)⚠️  WARNING: REMOTE DATABASE MODE (DEVELOPERS ONLY)$(RESET) $(BOLD)$(RED)║$(RESET)"
...
local:
	...
	@echo "$(CYAN)🌐 Frontend: http://localhost:3000$(RESET)"
	@echo "$(CYAN)🔧 Backend:  http://localhost:8000$(RESET)"
	@echo "$(CYAN)🗄️  Database: PostgreSQL (local)$(RESET)"
